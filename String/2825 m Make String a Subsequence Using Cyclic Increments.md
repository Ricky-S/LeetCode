...
class Solution:
    def canMakeSubsequence(self, str1: str, str2: str) -> bool:
        ...
        while start1 < len(str1):
            # print(f"{start1}, {str1[start1]}, {start2}, {str2[start2]}")
            # print(ord(str1[start1]) + 1)
            # print(ord(str2[start2]))
            if str1[start1] == str2[start2] or (ord(str1[start1]) + 1) % 26 == ord(str2[start2]) % 26:
                start2 += 1
                if start2 >= len(str2):
                    return True
            start1 += 1
